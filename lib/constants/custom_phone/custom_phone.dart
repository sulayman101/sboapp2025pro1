...
class CustomPhoneField extends StatefulWidget {
  ...
  ///
  /// ```dart
  /// initialCountryCode: 'So', // Somalia
  /// initialCountryCode: '+252', // Furaha Soomaaliya
  /// ```
...
class CustomPhoneFieldState extends State<CustomPhoneField> {
  ...
  void initState() {
    ...
    if (widget.initialCountryCode == null && number.startsWith('+')) {
      ...
      _selectedCountry = _countryList.firstWhere((item) => item.code == (widget.initialCountryCode ?? 'SO'),
          orElse: () => _countryList.first);
    ...
    return TextFormField(
      ...
      validator: (value) {
        ...
        if (!widget.disableLengthCheck) {
          if(_selectedCountry.code == 'SO'){
            return value.length >= _selectedCountry.minLength+1 && value.length <= _selectedCountry.maxLength+1
                ? null
      ...
      maxLength: widget.disableLengthCheck ? null : _selectedCountry.code == 'SO' ? _selectedCountry.maxLength+1 : _selectedCountry.maxLength,
