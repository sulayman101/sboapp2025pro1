    ...
    return ScaffoldWidget(
      appBar: AppBar(
        ...
        actions: [
          ...
          }, icon: Icon(Icons.notifications_active, color: notify ? Theme.of(context).colorScheme.primary : null,) )
        ],
      ),
      body: Column(
        children: [
                    ...
                    children: [
                      Expanded(
                        child: materialButton(
                            ...
                            onPressed: _uploading ? null : () => insertRow(),
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          MyTextFromField(
                                            labelText:
                                                providerLocale.bodyLblCategory,
                                            hintText:
                                                providerLocale.bodyHintCategory,
                                            textEditingController: _txtCat,
                                            maxLength: 30,
                                          ),
                                          MyTextFromField(
                                            labelText:
                                                providerLocale.bodyBookLblAr,
                                            hintText:
                                                providerLocale.bodyBookHintAr,
    ...
    try {
      ...
      if (result != null && result.files.isNotEmpty) {
        ...
        setState(() {
          ...
          log("File path for PDF: ${result.files.first.path}");
        });
      } else {
...
/*
  void insertRow() async {
    try {
      ...
      //final String? pdfDownloadUrl =await uploadPDFToStorage(File(_pdfFile!.path));

      //final DatabaseReference dbRef = FirebaseDatabase.instance.ref().child("SBO/Books/$selectedValue");

      final String bookName = txtCrtBName.value.text;
      final String bookAuth = txtCrtBAuth.value.text;
      final String bookPrice =
          txtCrtPrice.value.text.isEmpty ? "0" : txtCrtPrice.text;
